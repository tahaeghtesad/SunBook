    ...
    <div class="main pusher dimmer">
        ...
        <div class="ui grid">
            <div class="twelve wide column">
                <div class="ui piled green segment grid">
                    <div class="twelve wide column">
                          <h1 class="ui green header">طه اقتصاد<div class="sub header">کمان</div></h1>
                          <h3 class="ui blue header">شیراز<div class="sub header">فارس</div></h3>
                          <p>
                            علاقه مند به عکاسی،
                            برنامه نویس
                          </p>
                          <h2 class="ui yellow header">کارشناسی کامپیوتر<div class="sub header">دانشگاه شهید بهشتی</div></h2>
                    </div>
                ...
                <div class="ui purple piled segment">
